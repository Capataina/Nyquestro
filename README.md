...
- [x] Immutable event frames – zero-allocation structs for quotes & fills
- [x] Engine error enum – recoverable vs fatal classifications
...
- [ ] AF*XDP ingress prototype – zero-copy packet RX path *(stretch)\_
